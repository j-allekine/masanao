...
Superseded by [ADR 0005](0005-meal-schedule-as-issuance-context.md), which makes Meal Schedule the direct issuance context and removes the separate Schedule Entry layer.

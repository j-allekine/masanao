  ...
  return (
    ...
    >
      <MasterDataContent
        ...
        canManageUnits={canManageMasterDataResult}
        canManageOffices={canManageMasterDataResult}
        canManageCategories={canManageMasterDataResult}
        canManageVendors={canManageMasterDataResult}
      />
    </WorkspaceShell>
  );
}
